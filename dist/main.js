...
function setup() {  // setup p5
  ...
  buttonOffColour = 'rgba(158, 119, 163, 0.3)'; // default off colours for looper buttons
  buttonOnColour = 'rgba(163, 132, 119, 0.3)'; // default on colours for looper buttons
...
function welcomeScreen() {
  ...
  text("Oboe", width/2, height/10 * 2);
  textSize(cnvDimension/20);
  text( "Containing excerpts of Vaughan Williams’s Oboe Concerto played by Julian West.", width/10, height/10, (width/10) * 8, (height/10) * 8);
